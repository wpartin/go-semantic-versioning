...
func main () {
	...
	gh_release := flag.Bool("release", false, "[OPTIONAL] Create a GitHub Release with goreleaser. Must have goreleaser installed for this to work.")
	...
	if *version {
		...
		if *gh_release { pkg.CreateRelease(version) }
	}
}